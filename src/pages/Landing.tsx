...
const Landing = () => {
  return (
    <div className="min-h-screen bg-[#FFF4E0] relative overflow-hidden font-sans">
      {/* Círculo rojo */}
      <div className="absolute bg-[#BD1E22] w-[1500px] h-[1500px] rounded-full top-[-700px] right-[-500px] z-10"></div>
      ...
      <div className="relative z-20">
        ...
        <main className="flex flex-col md:flex-row items-center justify-start px-6 md:px-16 pt-4 pb-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start -translate-y-6 md:-translate-y-40 gap-4 md:gap-6 pl-4 md:pl-40">
            <h1 className="text-[#FF9D3A] text-[60px] md:text-[150px] font-tertiary leading-none uppercase">
              El Buen <br /> Sabor
            </h1>
            <Link to="/menu">
              <div className="mt-6 self-center">
                <button className="bg-[#FFF4E0] text-black px-15 py-2 font-primary rounded-full font-semibold shadow hover:scale-105 transition text-lg">
        ...
        <div className="flex flex-col items-center justify-center mt-10 mb-10 p-20">
          <div className="flex items-center justify-center gap-6 relative mb-12">
            <h2 className="font-tertiary text-7xl text-center leading-tight">
        ...
        {/* Menú */}
        <div>
          <h2 className="font-tertiary text-7xl text-center py-30">NUESTRO MENÚ</h2>
          <CardLanding items={items} />
          <img src={PizzanuestroMenu} alt="Pizza" className="w-[15vh] md:w-[25vh] lg:w-[30vh]" />
        </div>

        {/* Entrega */}
        <h2 className="font-tertiary text-7xl text-center py-30">Formas de entrega y pago</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto pb-25">
          <div className="space-y-6 text-lg">
            <p className="font-primary"> Elige los platos necesarios a través del menú y solicita la entrega.</p>
