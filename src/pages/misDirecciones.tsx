    ...
    return (
        <div className="bg-primary flex flex-col justify-center align-center">
            ...
            <div className='flex justify-center pt-8 pb-12'>
                <button className="bg-tertiary rounded-full text-md max-w-sm px-5 py-1 hover:scale-102 transition-transform duration-200"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-10 justify-center place-items-center sm:px-10 lg:px-40">
                {direcciones.map((d) => (
                    <div className="bg-secondary rounded-lg shadow-lg p-4 w-[335px]" key={d.id}>
                        ...
                        <div className='flex justify-around'>
                            <button
                                ...
                                className="flex bg-primary px-4 py-2 rounded-full mt-2 hover:scale-102 transition-transform duration-200">
                                Editar
                    ...
                    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-[350px] md:w-[450px] relative">
                            ...
                            <div className="flex justify-center items-center space-x-4">
                                <button
                                    className="bg-tertiary px-5 py-2 rounded-full hover:scale-102 transition-transform duration-200"
                                    onClick={() => {
