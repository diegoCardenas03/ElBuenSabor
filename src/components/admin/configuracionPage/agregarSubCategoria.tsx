...
interface AgregarSubcategoriaProps {
  ...
  setNuevaSubcategoria: (value: string) => void;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="bg-primary text-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6 relative border border-secondary z-50">
        <div className="flex justify-between items-start">
          <h3 className="font-semibold text-3xl font-bold mb-4 text-secondary">Agregar subcategoría</h3>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="flex justify-around gap-4 pt-4">
            ...
            <button type="submit" className="font-medium transition duration-150 ease-in-out hover:scale-110 cursor-pointer px-9 py-2 bg-tertiary text-white rounded-2xl" > Agregar </button>
          </div>
        </form>
      </div>
    </div>
